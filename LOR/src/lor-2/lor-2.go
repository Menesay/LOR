...
var (
	// lor-1 will connect
	// 1) LOR2IP:cliDATAPORT 			to send host:port data
	// 2) LOR2IP:cliPROXYPORT			to get proxy data
	cliDATAPORT  string
	cliPROXYPORT string
...
func help() {
	...
	helpMsg := ""
	helpMsg += "Useage:\n"
	helpMsg += "lor-2 cliDATAPORT cliPROXYPORT\n"
	helpMsg += "lor-2 -d 	debug mode (optional)"
	fmt.Println(helpMsg)
...
func main() {
	...
	// Debug
	fmt.Println(cliDATAPORT, cliPROXYPORT)
